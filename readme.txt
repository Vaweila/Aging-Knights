...
Enables the option to play with aging knights.

How To Install
Run the file 'install_mod.bat' as administrator.
In the main menu click 'Settings' > 'Mods'. Here you should be able to activate 'No Resource Boosts'.
