...
set thisPath=%~dp0%\
set modPath=%UserProfile%\AppData\LocalLow\BlackSeaGames\Sovereign\Saves\Mods\Aging Knights\
set gamePath=

:: YOU CAN MANUALLY SET THE GAMES PATH HERE! REMOVE THE TWO COLONS (::) BEFORE THE NEXT LINE TO USE IT
:: THIS HAS TO BE THE FOLDER WHERE THE 'steamapps'-FOLDER IS INSIDE.
